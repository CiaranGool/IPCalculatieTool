...
namespace CalculatorTool
{
    ...
    public partial class Form1 : Form
    {
        ...
        string Oppervlakte, Aantal, Type_Klus, Aantal_Messen, Ver_Werkuren, Ver_Middel1, Ver_Middel2, Ver_Middel3;
        ...
        string Naam1, Naam2, Naam3, Naam4, LPU1, LPU2, LPU3, LPU4, TotaleWerkuren1, TotaleWerkuren2, TotaleWerkuren3, TotaleWerkuren4;
        double WaardeNaam1, WaardeNaam2, WaardeNaam3, WaardeNaam4, WaardeLPU1, WaardeLPU2, WaardeLPU3, WaardeLPU4, WaardeTotaleWerkuren1, WaardeTotaleWerkuren2, WaardeTotaleWerkuren3, WaardeTotaleWerkuren4;
        ...
        private void btn_ExporterenNaarExcel_Click(object sender, EventArgs e)
        {
            ...
            #region Verwijderen
            //Opmaak.
            oSheet.get_Range("A3", "AC5").Font.Bold = true;
            ...
            oSheet.get_Range("A3", "AC5").Font.Color = Color.MidnightBlue;
            ...
            oSheet.get_Range("AC6", "AC6").Value2 = WaardeLPU1 * WaardeTotaleWerkuren2;
            ...
            oSheet.get_Range("AC7", "AC7").Value2 = WaardeLPU1 * WaardeTotaleWerkuren3;
            ...
            oSheet.get_Range("AC8", "AC8").Value2 = WaardeLPU1 * WaardeTotaleWerkuren4;
            ...
            oSheet.get_Range("A26", "A26").Value2 = Datum = dtp_Datum.Text;
            oSheet.get_Range("A28", "A28").Value2 = Opmerkingen;
        ...
        public void Loonberekening()
        {
            ...
            if (LPU1.All(Char.IsDigit) && LPU2.All(Char.IsDigit) && LPU3.All(Char.IsDigit) && LPU4.All(Char.IsDigit) && TotaleWerkuren1.All(Char.IsDigit) && TotaleWerkuren2.All(Char.IsDigit) && TotaleWerkuren3.All(Char.IsDigit) && TotaleWerkuren4.All(Char.IsDigit)
...

            {
                ...
                WaardeTotaleWerkuren1 = Convert.ToDouble(WaardeTotaleWerkuren1);
                WaardeTotaleWerkuren2 = Convert.ToDouble(WaardeTotaleWerkuren2);
                WaardeTotaleWerkuren3 = Convert.ToDouble(WaardeTotaleWerkuren3);
                WaardeTotaleWerkuren4 = Convert.ToDouble(WaardeTotaleWerkuren4);
            }
        }
        ...
        private void btn_Berekenen_Click(object sender, EventArgs e)
        {
            ...
            */
            ...
            lbl_TotaalVerwijderen.Text = "Totale kosten: €" + WaardeTotaal;
